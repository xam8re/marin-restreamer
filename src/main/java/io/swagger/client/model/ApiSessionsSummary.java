...
import io.swagger.client.model.ApiSessionSummary;
...
public class ApiSessionsSummary extends HashMap<String, ApiSessionSummary> {
  ...
  public String toString() {
    ...
    sb.append("class ApiSessionsSummary {\n");
